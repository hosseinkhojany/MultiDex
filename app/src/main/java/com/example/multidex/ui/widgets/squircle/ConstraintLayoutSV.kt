package com.example.multidex.ui.widgets.squircle
...
import com.example.multidex.R.styleable.*
import com.example.multidex.ui.widgets.squircle.SuperellipseLogic.getCachedBitmap


/**
 * You can follow this same pattern to implement the squircle background on other views and view-groups
 */
open class ConstraintLayoutSV : ViewGroup {
